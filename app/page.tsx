...
export default function TrashMailApp() {
    ...
    if (currentEmail) {
      try {
        if (navigator.clipboard && navigator.clipboard.writeText) {
          ...
          toast({
            title: "Copied!",
            description: "Email address đã được copy",
          })
        } else {
  ...
  const deleteEmail = async (emailId: string) => {
    try {
      ...
      toast({
        title: "Deleted",
        description: "Email đã được xóa thành công",
      })
    } catch (error) {
      toast({
        title: "Error",
  ...
  const loadMyEmails = async () => {
    ...
    try {
      ...
      console.error("Không thể tải email người dùng:", error)
    }
  }
          ...
          <div className={`p-4 rounded-lg border ${darkMode ? "bg-yellow-900/20 border-yellow-700 text-yellow-200" : "bg-yellow-50 border-yellow-200 text-yellow-800"}`}>
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="font-semibold mb-1">Bạn đang sử dụng chế độ ẩn danh</p>
                <p className="text-sm opacity-90">
                  Email của bạn là tạm thời. 
                  <Link href="/login" className="underline ml-1 font-medium hover:opacity-80">
                    Đăng nhập hoặc đăng ký
                  </Link> để lưu email của bạn và truy cập chúng từ bất kỳ thiết bị nào.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mb-12">
            ...
            <div className="max-w-2xl mx-auto mb-6">
              ...
              <p className={`text-sm mt-2 ${darkMode ? "text-gray-400" : "text-gray-500"}`}>
                💡 Để trống để tạo email ngẫu nhiên, hoặc nhập địa chỉ tùy chỉnh của bạn
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <Card className={darkMode ? "bg-gray-800 border-gray-700" : ""}>
              <CardContent className="p-6 text-center">
                ...
                <p className={`text-sm ${darkMode ? "text-gray-400" : "text-gray-600"}`}>
                  Nhận email tạm thời trong vài giây. Không cần đăng ký.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className={darkMode ? "bg-gray-800 border-gray-700" : ""}>
              <CardContent className="p-6 text-center">
                ...
                <p className={`text-sm ${darkMode ? "text-gray-400" : "text-gray-600"}`}>
                  Bảo vệ quyền riêng tư của bạn. Không yêu cầu thông tin cá nhân.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className={darkMode ? "bg-gray-800 border-gray-700" : ""}>
              <CardContent className="p-6 text-center">
                ...
                <h3 className={`font-semibold mb-2 ${darkMode ? "text-white" : "text-gray-900"}`}>Tự động hết hạn</h3>
                <p className={`text-sm ${darkMode ? "text-gray-400" : "text-gray-600"}`}>
                  Email sẽ tự động xóa sau khi hết hạn. Giữ hộp thư của bạn sạch sẽ.
                </p>
              </CardContent>
            </Card>
          </div>
                                    ...
                                    <div className="space-y-3">
                                      ...
                                      <div className="p-3 bg-blue-50 dark:bg-blue-950 rounded-lg border border-blue-200 dark:border-blue-800">
                                        ...
                                        <p className="text-xs text-muted-foreground mt-2">
                                          hoặc nhấn <kbd className="px-1.5 py-0.5 bg-gray-100 dark:bg-gray-800 rounded border text-xs">Enter</kbd>
                                        </p>
                                      </div>
                                    </div>
                                  ) : (
                                    <p className="text-muted-foreground">Nhập để tìm kiếm hoặc tạo email</p>
                                  )}
                                </div>
                              </CommandEmpty>
                ...
                {filteredEmails.length === 0 ? (
                  <div className="p-8 text-center">
                    ...
                    <p className={`text-sm ${darkMode ? "text-gray-400" : "text-gray-500"}`}>
                      Email bạn nhận được sẽ hiển thị ở đây.
                    </p>
                  </div>
                ) : (
                  <>
      ...
      <footer className={`mt-16 py-8 border-t ${darkMode ? "border-gray-700 bg-gray-900" : "border-gray-200 bg-white"}`}>
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col items-center justify-center gap-4">
            <p className={`text-sm ${darkMode ? "text-gray-400" : "text-gray-600"}`}>
              © 2025 MailDelivery. Protect your privacy with temporary email addresses.
            </p>
          </div>
        </div>
      </footer>
          ...
          <div className="min-h-screen w-full flex items-center justify-center p-2 sm:p-4 py-8">
            ...
            <div className="bg-gradient-to-r from-yellow-400 via-orange-400 to-red-500 dark:from-yellow-600 dark:via-orange-600 dark:to-red-600 p-3 sm:p-6 text-center relative">
              ...
              <div className="flex items-center justify-center gap-1 sm:gap-3 mb-2">
                ...
                <h2 className="text-lg sm:text-3xl md:text-4xl font-black text-white uppercase tracking-wider">
                  THÔNG BÁO QUAN TRỌNG
                </h2>
                <AlertTriangle className="h-6 w-6 sm:h-10 sm:w-10 text-white animate-pulse flex-shrink-0" />
              </div>
              <p className="text-white/90 text-xs sm:text-lg font-semibold">
            ...
            <div className="p-3 sm:p-8 space-y-4 sm:space-y-6">
              ...
              <div className="flex justify-center pt-2 sm:pt-4 pb-2">
                <Button
                  onClick={() => setShowDonatePopup(false)}
                  size="lg"
                  className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-8 sm:px-12 font-semibold w-full sm:w-auto"
                >
                  Đóng
                </Button>
              </div>
